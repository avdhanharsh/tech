...
<section class="dashboard">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p style="background-color: #8e44ad; color:white">total Videos</p>
         <!-- <a href="add_content.php" class="btn">add new content</a> -->
      </div>

      <div class="box">
         <h3><?= $total_playlists; ?></h3>
         <p style="background-color: #8e44ad; color:white">total playlists</p>
      ...
      <!-- <div class="box">
         <h3><?= $total_paper; ?></h3>
         <p style="background-color: #8e44ad; color:white">total Paper</p>
         <a href="add_paper.php" class="btn">add new paper </a>
      </div> -->

      <!-- <div class="box">
         <h3><?= $total_books; ?></h3>
         <p style="background-color: #8e44ad; color:white">total Books</p>
